	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="register">
            ...
            <p>
                ...
                <input name="billing_last_name" id="billing_last_name" type="text">
            </p>

            <p>
                <label for="billing_phone"><?php _e( 'Phone', 'woocommerce' ); ?> <span class="required">*</span></label>
                <input name="billing_phone" id="billing_phone" type="tel">
            </p>
            ...
            <p>
                ...
                <select name="billing_country" id="billing_country">
                    ...
                    foreach ($countries as $country_code => $country_name){
                        ?><option value="<?= $country_code; ?>"><?= $country_name; ?></option><?php
                    }
                    ?>
                </select>
            </p>
            ...
            <p>
                ...
                <input name="billing_city" id="billing_city" type="text">
            </p>

            <p>
                <label for="billing_address_1">Улица <span class="required">*</span></label>
                <input name="billing_address_1" id="billing_address_1" type="text">
            </p>

            <p>
                <label for="billing_address_2">Дом <span class="required">*</span></label>
                <input name="billing_address_2" id="billing_address_2" type="text">
            </p>

            <p>
                <label for="billing_company">Квартира / офис <span class="required">*</span></label>
                <input name="billing_company" id="billing_company" type="text">
            </p>
